...
date
# install v2ray
wget https://raw.githubusercontent.com/dragonsth/online/main/go.sh && chmod +x go.sh && ./go.sh
rm -f /root/go.sh
mkdir /root/.acme.sh
...
cd /usr/bin
wget -O tj "https://raw.githubusercontent.com/dragonsth/online/main/add-trgf.sh"
chmod +x tj
